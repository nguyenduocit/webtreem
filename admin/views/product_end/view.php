  ...
  class showData
  {
   ...
   public  function __construct()
    ...
    public function show_list()
    {
      ...
      return $data = $this->db->fetchwhere('product',' qty <= 5 ');
...
<div class="right_col" role="main">
  <div class="">
    <div class="page-title">
        <div class="title_left">  <h3>Danh sách sản phẩm sắp hết
        </h3>  </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 form-group pull-right ">
                ...
                <a href="index.php?action=add" class="btn btn-round btn-primary" style="float: right;">end </a>
