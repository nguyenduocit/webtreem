    ...
    <div class="col-md-12 col-sm-12 col-xs-12 ">
	  	<div class="col-md-4 col-sm-4 col-xs-12">
	        <div class="x_panel tile fixed_height_320">
	            ...
	            <div class="x_content br">
	                <div class="widget_summary">
	                    <div class="col-md-6">Số giao dịch đã xử lý</div>
	        ...
	        <div class="x_panel tile fixed_height_320">
	            ...
	            <div class="x_content br">
	                <div class="widget_summary">
	                    ...
	                    <div class="col-md-6"><b class="text-danger"><?php echo number_format($num_pay); ?> VNĐ</b></div>
	                </div>                        
	            </div>
	            <div class="x_content br">
	                <div class="widget_summary">
	                    <div class="col-md-6">Đang chờ xử lý</div>
	                    <div class="col-md-6"><b class="text-danger"><?php echo number_format($num_pending);?> VNĐ</b></div>
	                </div>                        
	            </div>
	        </div>       
		</div>	
	                ...
	                <tbody>
	                    <tr>
	                        ...
	                        <td class="text-center">
	                            ...
	                            <a href="<?php echo '../../controller/Active.php?action=pay&id='.$value['id'] ;?>" class="btn btn-xs btn-default active-info" data-active="32">Chưa thanh toán</a>
	                        	<?php else: ?>
	                        		Đang chờ xử lý .
	                        	<?php endif; ?>
	                        </td>
