...
<div id="sidebar" class="sidebar widget-area">
    ...
    <div id="text-21" class="widget widget_text">
        <div class="widget-wrap">
            <h4 class="widget-title widgettitle">Hỏi &#8211; Đáp</h4>
            <div class="textwidget">
                <ul class="cauhoimoi">
                    
                        <li><a href="hoi-dap.php">Hiện nay trên mạng tôi thấy có rất nhiều website mang tên ShopTreEm, vậy làm sao để biết được Shop nào là THẬT shop nào là GIẢ MẠO?</a></li>
                        <li><a href="hoi-dap.php">Tôi muốn đến tận nơi để xem, chọn và mua hàng có được không?</a></li>
                        <li><a href="hoi-dap.php">Shoptreem có giao hàng tận nơi không?</a></li>
                        <li><a href="hoi-dap.php">Thời gian giao hàng của Shoptreem.com như thế nào?</a></li>
                        <li><a href="hoi-dap.php">Tôi ở xa Hà Nội thì mua hàng như thế nào?</a></li>
    ...
    <div id="caia-post-list-2" class="widget caia-post-list-widget">
        <div class="widget-wrap">
            ...
            <p class="more-from-category"><a href="list_new.php" title="Mẹ và Bé">xem thêm...</a></p>
        </div>
    </div>
            ...
            <div class="ads_content_widget">
                <div class="fb-page" data-href="" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                    <div class="fb-xfbml-parse-ignore">
                        <blockquote cite=""><a href="">ShopTreEm</a></blockquote>
                    </div>
                </div>
            </div>
        </div>
